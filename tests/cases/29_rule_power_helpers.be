...
wp1.Counter1BeforeStart = 100
SIM['cmds'] = list()
var d = wp1._compensate_backflow(300)
...
wp1.Counter1BeforeStart = 100
SIM['cmds'] = list()
d = wp1._compensate_backflow(150)
...
SIM['cmds'] = list()
wp1.LastFloodVol = 0
wp1._record_flood(250)
assert_eq(wp1.LastFloodVol, 250, "volume accumulated")
...
assert_eq(wp1.LastFloodTime, SIM['rtc_local'], "last flood time recorded")
...
wp1.MaxFlood = 2000
wp1.LastFloodVol = 0
wp1._record_flood(1100)
assert_eq(wp1.LastFloodVol, 1100, "volume accumulated")
var st2 = SIM['timers']['ID_SOILTRANSITION_AFTERFLOOD']
...
wp1.LastFloodVol = 0
wp1._record_flood(100)
var st3 = SIM['timers']['ID_SOILTRANSITION_AFTERFLOOD']
...
wp1._end_session_no_water()
assert_eq(wp1.PauseSoilMaxStat, false, "pause lifted")
assert_eq(wp1.AutofloodInProcess, false, "session closed without soil check timer")
...
assert_true(SIM['timers'].find("ID_SOILTRANSITION_AFTERFLOOD") != nil, "soil timer armed from record_flood")
