...
| `23_web_deinit` | web_add_main/config_button (HTML: кнопки Calibration и Toggle Conf есть, `Reset water counter` с главной УБРАН — перенесён в Common detail; инжект содержит `_wdSettingsOpen` и суффиксные `m_soildry_`; bare-форм Soil Dry/Wet/Dry threshold/Soak dose на главной НЕТ), deinit: снятие правил/cron/cmd, off насоса, `Store.flush(true)` (persist.save) |
