...
| `23_web_deinit` | web_add_main/config_button (HTML: кнопки Calibration и Toggle Conf есть, `Reset water counter` с главной УБРАН — перенесён в Common detail), deinit: снятие правил/cron/cmd, off насоса, `Store.flush(true)` (persist.save) |
